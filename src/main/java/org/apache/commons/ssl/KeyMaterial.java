/*
 * $HeadURL: file:///opt/dev/not-yet-commons-ssl-SVN-repo/tags/commons-ssl-0.3.17/src/java/org/apache/commons/ssl/KeyMaterial.java $
 * $Revision: 138 $
        ...
        while (it.hasNext()) {
            ...
            if (certs != null) {
                for (final X509Certificate cert : certs) {
                    buf.append(Certificates.toString(cert));
                    try {
                        buf.append(Certificates.toPEMString(cert));
